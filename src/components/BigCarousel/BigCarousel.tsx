...
const getMovieComponent = (movie: movie, styleComponent: CSSProperties): JSX.Element => {
  return (
    <div
  ...
  return (
    <div className={style.carousel} style={stylesCarousel}>
      <div 
        ...
        ref={wrapperMovies}
      >
        {getMovieComponent(movies[movies.length - 1], stylesMovie)}

        {movies.map(movie => getMovieComponent(movie, stylesMovie))}

        {getMovieComponent(movies[0], stylesMovie)}
      </div>
